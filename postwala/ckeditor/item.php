		...
		if(checkMathCaptcha($idItem))	{
			if (isEmail(cP("email"))){//is email
				if(!isSpam(cP("name"),cP("email"),cP("msg"))){//check if is spam!
                    ...
                    $message="<p>".$cusName." (".cP("email").") ".T_("contacted you about the Ad") ."&nbsp;<a href='".$LinkUrl."'>".cP("itemTitle")."</a><br /><br />".$cusName."&nbsp;". T_("responded that :") ."<br/>&nbsp;".
							 cP("msg").
							 "<br /><br />".T_("Do not answer this email, answer to this email").": ".cP("email")."</p>";
