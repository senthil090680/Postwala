...
<script type="text/javascript">
	...
	function deleteCategory(category){
		if (confirm('<?php _e("Are You Sure You Want to Delete Category");?> "'+document.getElementById('name-'+category).innerHTML+'"?'))
...
<?php 
		echo '<form  action="categories.php" method="get" >';
				...
				sqlOptionGroup($query,"cid",cG("cid"));
...
<table>
	...
	<tr <?php echo $row_class;?>>      
		...
		<td class="action">
			<a href="" onclick="editCategory('<?php echo $idCategory; ?>', '<?php echo $order;?>','<?php echo $parent;?>');return false;" class="edit"><?php _e("Edit");?></a> 
