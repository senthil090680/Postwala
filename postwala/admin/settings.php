...
<div class="settingsTitle" onclick="openClose('bconf');"><h3><?php _e("Basic Configuration");?></h3></div>
...
<div class="settingsTitle" onclick="openClose('dbconf');"><h3><?php _e("Database Configuration");?></h3></div>
...
<div class="settingsTitle" onclick="openClose('smtpconf');"><h3><?php _e("Mail Server Configuration");?></h3></div>
...
<div class="settingsTitle" onclick="openClose('iniconf');"><h3><?php _e("Initial Settings");?></h3></div>
...
<div class="settingsTitle" onclick="openClose('look');"><h3><?php _e("Look and Feel");?></h3></div>
...
<div class="settingsTitle" onclick="openClose('paypal');"><h3><?php _e("Paypal Configuration");?></h3></div>
...
<div class="settingsTitle" onclick="openClose('advert');"><h3><?php _e("Adsense and Advertising");?></h3></div>
...
<div class="settingsTitle" onclick="openClose('sidebarconf');"><h3><?php _e("Sidebar");?></h3></div>
...
<div class="settingsTitle" onclick="openClose('imgconf');"><h3><?php _e("Image Settings");?></h3></div>
...
<div class="settingsTitle" onclick="openClose('Sitemap');"><h3><?php _e("Rss & Sitemap");?></h3></div>
...
<div class="settingsTitle" onclick="openClose('cache');"><h3><?php _e("Cache Configuration");?></h3></div>
...
<div class="settingsTitle" onclick="openClose('etools');"><h3><?php _e("External Tools");?></h3></div>
